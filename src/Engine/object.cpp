...
Object::Object(const unsigned char* texture, const int texWid, const int texHgt, Vector3D vel, Point3D pos, float _rx, float _ry, float _rz)
{
	velocity = vel;
	position = pos;
	tex = texture;
...
Object::Object(Poly poly, const unsigned char* texture, const int texWid, const int texHgt, Vector3D vel, 
...
void Object::GenerateShot(Vector3D pos, float theta_, float phi_) {
	...
	master.begin()->SetfloatSided(true);
	master.begin()->SetVertexColors(rand()/(float)RAND_MAX,rand()/(float)RAND_MAX,rand()/(float)RAND_MAX,
									rand()/(float)RAND_MAX,rand()/(float)RAND_MAX,rand()/(float)RAND_MAX,
									rand()/(float)RAND_MAX,rand()/(float)RAND_MAX,rand()/(float)RAND_MAX);
...
void Object::GeneratePlayer(Vector3D pos, float theta_, float phi_,const unsigned char* texture, const int texWid, const int texHgt) {
	tex = texture;
	texWidth = texWid;
	texHeight = texHgt;
	GenerateCube();
