...
public:
	...
	const unsigned char* texture;	// for texturing
	...
	bool floatsided;	// for floatsided polygons
    ...
    Poly(const Vertex& _v1,
		 ...
		 const unsigned char* tex = defaulttexture,
	...
	void SetfloatSided( bool ds ) { floatsided = ds; }
	bool GetfloatSided( void ) { return floatsided; }
	void SetTexture( const unsigned char *tex, 
	...
	void Rasterize( float* zbuff, char* dispbuff );
	void Rasterize( const int y, float* zbuff, char* dispbuff );
	void RasterizeFast( float* zbuff, char* dispbuff );
	void RasterizeFast( const int y, float* zbuff, char* dispbuff );
