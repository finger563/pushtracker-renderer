...
public:
	...
	Object(const unsigned char* texture, const int texWid, const int texHgt, Vector3D vel = Vector3D(0,0,0), 
		Point3D pos = Point3D(0,0,0), float _rx = 0, float _ry = 0, float _rz = 0);

	//Alternate Constructor
	Object(Poly poly, const unsigned char* texture, const int texWid, const int texHgt, Vector3D vel = Vector3D(0,0,0), 
		Point3D pos = Point3D(0,0,0), float _rx = 0, float _ry = 0, float _rz = 0);
	...
	void GeneratePlayer(Vector3D pos, float theta_, float phi_, 
		const unsigned char* texture = boxtexture, const int texWid=boxtexturewidth, const int texHgt=boxtextureheight);
